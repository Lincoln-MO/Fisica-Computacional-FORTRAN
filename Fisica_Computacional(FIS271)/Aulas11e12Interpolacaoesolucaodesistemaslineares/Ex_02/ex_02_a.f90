...
!OBS:Neste programa considerei minha matriz A como sendo a matriz x do roteiro, a matriz b equivale a matriz y do roteiro e os coeficiêntes aqui buscadodos são os valores de x que no roteiro são os an
!----------------------------------------Subrotinas---------------------------------------------------------
