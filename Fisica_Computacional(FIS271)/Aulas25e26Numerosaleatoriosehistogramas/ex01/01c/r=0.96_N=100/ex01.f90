...
implicit none
	...
	Real*8 , parameter		:: r = 0.96
	integer 			:: i
	Real*8,	dimension(0:N)		:: x01, x03, x05, x07, x09 
	character(len=28), parameter 	:: arquivo_01 = "Populacao01_r=0.96_N=100.dat"
 	character(len=28), parameter	:: arquivo_03 = "Populacao03_r=0.96_N=100.dat"
 	character(len=28), parameter	:: arquivo_05 = "Populacao05_r=0.96_N=100.dat"
 	character(len=28), parameter	:: arquivo_07 = "Populacao07_r=0.96_N=100.dat"
 	character(len=28), parameter	:: arquivo_09 = "Populacao09_r=0.96_N=100.dat"
x01(0) = 0.1d0
x09(0) = 0.9d0
