...
implicit none
	...
	Real*8 , parameter		:: r = 0.63
	integer 			:: i
	Real*8,	dimension(0:N)		:: x01, x03, x05, x07, x09 
	character(len=27), parameter 	:: arquivo_01 = "Populacao01_r=0.63_N=40.dat"
 	character(len=27), parameter	:: arquivo_03 = "Populacao03_r=0.63_N=40.dat"
 	character(len=27), parameter	:: arquivo_05 = "Populacao05_r=0.63_N=40.dat"
 	character(len=27), parameter	:: arquivo_07 = "Populacao07_r=0.63_N=40.dat"
 	character(len=27), parameter	:: arquivo_09 = "Populacao09_r=0.63_N=40.dat"
x01(0) = 0.1d0
x03(0) = 0.3d0
x05(0) = 0.5d0
x07(0) = 0.7d0
