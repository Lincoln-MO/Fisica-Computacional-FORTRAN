...
implicit none
	...
	character(len=28), parameter 	:: arquivo_01 = "Populacao01_r=0.24_N=500.dat"
 	character(len=28), parameter	:: arquivo_03 = "Populacao03_r=0.24_N=500.dat"
 	character(len=28), parameter	:: arquivo_05 = "Populacao05_r=0.24_N=500.dat"
